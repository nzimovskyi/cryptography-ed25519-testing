...
const seed = Buffer.alloc(32, 1); // Тестовий ключ
const message = new Uint8Array(64).fill(101); // Тестове повідомлення (64 байти)

async function runBenchmark() {
    console.log(`\n🚀 Порівняння продуктивності Ed25519 (${ITERATIONS} ітерацій)`);
    console.log('--------------------------------------------------');

    // 1. Тестування tweetnacl
    ...
    // 2. Тестування @noble/ed25519
    // Попередньо генеруємо ключ
